...
else
{
	...
	{
		case 1:
				%><script type="text/javascript">alert("Product edited successfully.")</script> <%
			break;
		case 2:
			%><script type="text/javascript">alert("Error while edit product, please try after sometime.")</script> <%
			break;
		case 3:
...
<div class="row-fluid ">    <div class="span16 breadcrumbs-grid" >
    ...
    <div class="ty-breadcrumbs clearfix">
        <a href="index.jsp" class="ty-breadcrumbs__a">Home</a><span class="ty-breadcrumbs__slash">/</span><span class="ty-breadcrumbs__current">Edit Product</span>
    </div>
...
<% 	
		...
		rs = st.executeQuery("SELECT PRD.PRODUCT_TITLE AS prdTitle, PRD.PRODUCT_DESC AS prdDesc, PRD.PRODUCT_PRICE AS prdPrice, PRD.MIN_BID  AS minBid, PRD.IMAGE AS imagePath FROM auctionms_product_mst PRD , auctionms_user_mst USERS WHERE PRD.SELLER_ID = USERS.USER_ID AND PRD.PRODUCT_ID='"+prdId+"' AND USERS.email='"+UserID+"'");
		String prdTitle = null;
		String prdDesc = null;
		float prdPrice = 0;
		float minBid = 0;
		String imgPath = null;
		...
		{
			sessionUploadProduct.setAttribute("invalidUrl", "1");
	...
	<div class="ty-control-group">
            ...
            <input type="text" id="title" name="product_data[title]" size="32" maxlength="128" value="<%=prdTitle%>" class="ty-input-text" data-validation="length alphanumeric" data-validation-length="min4" />
        </div>	
		
	<div class="ty-control-group">
            <label for="description" class="cm-required ty-control-group__title cm-lname">Description</label>
            <input type="text" id="description" name="product_data[description]" size="32" maxlength="128" value="<%=prdDesc%>" class="ty-input-text" data-validation="length alphanumeric" data-validation-length="min4" />
        </div>	
    ...
    <div class="ty-control-group">
            ...
            <input type="text" id="mrp" name="product_data[mrp]" size="32" maxlength="128" value="<%=prdPrice%>" class="ty-input-text cm-numeric" />
    </div>
    
    <div class="ty-control-group">
            <label for="minimum" class="ty-control-group__title cm-required cm-minimum">Minimum Bid Amount</label>
            <input type="text" id="minimum" name="product_data[minimum_bid]" size="32" maxlength="128" value="<%=minBid%>" class="ty-input-text cm-numeric" />
    </div>
	
	<div class="ty-control-group">
            <label for="pic" class="ty-control-group__title cm-pic">Product Picture</label>
			<img class="ty-pict" src="<%=imgPath%>" alt="" title="" style="width:150px;height:150px;">
    ...
    <button  class="ty-btn__secondary ty-btn" type="submit" >Edit Product</button>
